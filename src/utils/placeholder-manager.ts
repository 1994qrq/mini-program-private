...
const DEFAULT_PLACEHOLDERS: Record<string, string[]> = {
  ...
  familiar_module: ['请输入对方的问题', '搜索相关内容', '输入关键词查询'],
  unfamiliar_module: ['请输入对方的问题', '搜索相关内容', '输入关键词查询'],
  strange_module: ['请输入对方的问题', '搜索相关内容', '输入关键词查询'],
  super_familiar_module: ['请输入对方的问题', '搜索相关内容', '输入关键词查询'],
  free_module: ['请输入对方的问题', '搜索相关内容', '输入关键词查询'],
};
